package com.tianlin.myapplication.control;

import android.content.Context;

import com.tianlin.myapplication.recognization.IRecogListener;
...
public class MyRecognizer {
     ...
     * @param eventListener
     */
    public MyRecognizer(Context context, RecogEventAdapter eventListener) {
        if (isInited) {
