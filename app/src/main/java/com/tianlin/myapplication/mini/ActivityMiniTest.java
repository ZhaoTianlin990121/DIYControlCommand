package com.tianlin.myapplication.mini;

import android.os.Message;
import android.util.Log;
import android.view.View;

import com.tianlin.myapplication.ActivityCommon;
import com.tianlin.myapplication.test.AlarmListener;
import com.tianlin.myapplication.test.SpeechTestCase;
import com.tianlin.myapplication.recognization.RecogEventAdapter;
import com.tianlin.myapplication.recognization.inputstream.InFileStream;
import com.tianlin.myapplication.util.Logger;
...
//            txtLog.append("filename:" + filename + " does  not exist");
            ...
            params.put(SpeechConstant.IN_FILE,
                    "#com.tianlin.myapplication.recognization.inputstream.InFileStream.create16kStream()");
