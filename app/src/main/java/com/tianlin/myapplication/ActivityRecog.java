...
import com.tianlin.myapplication.control.MyRecognizer;
import com.tianlin.myapplication.recognization.CommonRecogParams;
import com.tianlin.myapplication.recognization.IStatus;
import com.tianlin.myapplication.recognization.MessageStatusRecogListener;
import com.tianlin.myapplication.recognization.StatusRecogListener;
import com.tianlin.myapplication.recognization.offline.OfflineRecogParams;
import com.tianlin.myapplication.util.AutoCheck;
...
//                        txtLog.append(message + "\n");
    ...
    // 以上为 语音SDK调用，以下为UI部分
    @Override
    protected void onCreate(Bundle savedInstanceState) { System.out.println("w");super.onCreate(savedInstanceState); }
